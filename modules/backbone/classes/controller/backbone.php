...
class Controller_Backbone extends Controller_REST {
	...
	public function before()
	{
		...
		// Using file_get_contents("php://input") instead since request body is not aviable due to hack in Kohana_Request
		
		// Set the input property
		// $this->_input = (array) json_decode($this->request->body(), TRUE);
		$this->_input = (array) json_decode(file_get_contents("php://input"), TRUE);
